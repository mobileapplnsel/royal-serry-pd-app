...
export default class PendingOrderViewModel extends BaseViewModel{
}
export  class PendingOrderPage extends BaseComponent<
  any,
  PendingOrderViewModel
> {
  constructor(props: any) {
    super(props);
    this.state = new BaseState(new PendingOrderViewModel());
