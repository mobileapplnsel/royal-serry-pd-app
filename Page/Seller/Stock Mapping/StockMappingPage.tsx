...
export default class StockMappingViewModel extends BaseViewModel{
  OTPId:string;
  CustomerId:string;
  FirstName:string="";
  LastName:string="";
...
export  class StockMappingPage extends BaseComponent<
  any,
  StockMappingViewModel
> {
  constructor(props: any) {
    super(props);
    this.state = new BaseState(new StockMappingViewModel());
